...
;; this file is the same as the adjacent file "ddict.rkt",
;; but it requires and tests the private file instead
;; of the contracted interface. Probably overkill... oh well
